...
export default function Home() {
  ...
  const [useSkill, setUseSkill] = useState(pikachu_default);
  ...
  const showBattleField = () => {
    return (
      <div className="h-screen w-full flex flex-row bg-[url(https://images-wixmp-ed30a86b8c4ca887773594c2.wixmp.com/f/dccf9b3c-e552-4a19-ba30-2b86db58123e/dcewmcd-61655f8d-e893-45cc-9886-c8d1c9503371.png/v1/fill/w_1024,h_527,q_80,strp/forest_battle_background_by_aamatniekss_dcewmcd-fullview.jpg?token=eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..5dxJyWYKf42J-QDbSwroSssDATAqhLtnHsYLc-XBHNo)] bg-center bg-cover">
        <div className="absolute bottom-0 right-0 z-10 bg-gradient-to-tl from-black/40 h-screen w-full" />
        <div className="basis-1/2 h-full w-full">
          <div className="font-semibold flex flex-col justify-end pb-20 items-center h-full">
        ...
        <div className="basis-1/2  h-full w-full">
          <div className="font-semibold flex flex-col justify-center  items-center h-full">
            {/* <Image
              src={charizard_default}
              height={300}
              width={300}
